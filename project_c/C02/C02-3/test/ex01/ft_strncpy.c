 ...
 *
 * @note this function is useful in situations where you want to copy
 * a strin g number from one string to aojther and ensure thaat the destination 
 * is properly padded with null characters if needed. However, 
 * one must be cautious
 * about  the llack of null-terminating when src has more characters than `n`.
 *
 * @example
 * ```c
